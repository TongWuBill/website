...
$projects = get_projects_by_category('ai');
...
<div class="work-wrap">
  ...
  <div class="work-page-header">
    ...
    <p class="work-page-subtitle"><?= t('ai.subtitle') ?></p>
  </div>
  ...
  <div class="work-grid">
    ...
    <?php if (empty($projects)): ?>
      <p style="color:#aaa;font-style:italic;font-size:0.9rem">No projects yet.</p>
    <?php endif; ?>
  </div>
